//
//  FPPhotoViewControllerDelegate.h
//  判断相片是否存在
//
...
#ifndef FPPhotoViewControllerDelegate_h
#define FPPhotoViewControllerDelegate_h

@class PHAsset;
@protocol FPPhotosViewControllerDelegate <NSObject>
...
#endif /* FPPhotoViewControllerDelegate_h */
