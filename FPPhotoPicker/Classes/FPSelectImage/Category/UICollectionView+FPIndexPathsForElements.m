...
@implementation UICollectionView (FPIndexPathsForElements)
...
- (NSArray<NSIndexPath *> *)indexPathsForElementsInRect:(CGRect)rect
{
    ...
    return [allLayoutAttributes fp_map:^id _Nonnull(UICollectionViewLayoutAttributes * _Nonnull attribute) {
